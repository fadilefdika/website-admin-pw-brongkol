  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-3xl">
        <DialogHeader>
          <DialogTitle>Tambah Data Tanaman</DialogTitle>
          <DialogDescription>
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
          ...
          <div className="flex flex-col">
            <Label htmlFor="aksesi" className="mb-2">
              Aksesi
            </Label>
          ...
          <div className="flex flex-col">
            <Label htmlFor="tanggal-penanaman" className="mb-2">
              Tanggal Penanaman
            </Label>
            <Popover>
        ...
        <div className="mt-5">
          <Label htmlFor="catatan" className="mb-2">
            Catatan Tambahan
          </Label>
